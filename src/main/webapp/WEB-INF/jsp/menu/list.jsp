                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div    class="form-row"  style="margin: 0.3125rem 0;">
                                <form class="form-inline navbar-form navbar-left" method="get" action="${pageContext.request.contextPath}/menu/list">
                                    <!-- 搜索框 -->
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="zero_config" class="table  table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  href="${pageContext.request.contextPath}/menu/showmenu/?empId=${emp.empid}">分配权限</a>
                                    </td>
                                </tr>
                                </c:forEach>
                                </tbody>
                                    ...
                                    <td colspan="10">
                                        <div style="float: right;">
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/menu/list?currPage=${pages.first}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">首页</a></li>
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/menu/list?currPage=${pages.pre}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">上一页</a></li>
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/menu/list?currPage=${pages.next}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">下一页</a></li>
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/menu/list?currPage=${pages.last}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">末页</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
