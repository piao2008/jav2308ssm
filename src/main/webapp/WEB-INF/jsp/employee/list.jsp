                                ...
                                <form class="form-inline navbar-form navbar-left" method="get" action="${pageContext.request.contextPath}/employee/list">
                                    ...
                                    <div class="input-group" style="margin-right: 0.3125rem;">
                                        ...
                                        <span class="input-group-btn">
											...
											<a href="${pageContext.request.contextPath}/employee/append" class="btn btn-primary" style="margin-left: 5px;">添加</a>
										</span>
                                        <span class="input-group-btn">
											<a href="javascript:;" id="deleteAll" deletes_url="${pageContext.request.contextPath}/employee/removebyids?empIds=" class="btn btn-danger" style="margin-left: 5px;" >批量删除</a>
										</span>
                                    </div>
                                </form>
                            </div>
                                ...
                                <tr>
                                    <th>
                                        <label class="customcheckbox">
                                            <input type="checkbox" class="listCheckbox" name="c" value="${emp.empid }"/>
                                            <span class="checkmark"></span>
                                        </label>
                                    </th>
                                    ...
                                    <td>
                                        <a href="javascript:;" name="deleteRow" delete_url="${pageContext.request.contextPath}/employee/removebyid?empId=" key="${emp.empid}">删除</a>
                                        <a  href="${pageContext.request.contextPath}/employee/edit?empId=${emp.empid}">修改</a>
                                    </td>
                                </tr>
                                </c:forEach>
                                </tbody>
                                    ...
                                    <td colspan="10">
                                        <div style="float: right;">
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/list?currPage=${pages.first}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">首页</a></li>
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/list?currPage=${pages.pre}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">上一页</a></li>
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/list?currPage=${pages.next}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">下一页</a></li>
                                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/list?currPage=${pages.last}&empname=${employee.empname}&loginname=${employee.loginname}&departid=${employee.departid}&state=${employee.state}&positionid=${employee.positionid}">末页</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
