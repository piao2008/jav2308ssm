  ...
  <div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
      <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
          <h4 class="page-title">部门管理 - 添加</h4>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/departinfo/append">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control"  name="departemail"  placeholder="DepartEmail Here">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="DepartTel" class="col-sm-3 text-right control-label col-form-label">部门电话</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control"  name="departtel"  placeholder="DepartTel Here">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="departDesc" class="col-sm-3 text-right control-label col-form-label">部门描述</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="departdesc"   placeholder="DepartDesc Here">
                  </div>
                </div>
              </div>
