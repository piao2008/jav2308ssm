    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/schedule/modifybyid">
                           <input type="hidden" name="scheduleid" value="${schedule.scheduleid}">
                            ...
                            <div class="border-top">
                                <div class="card-body">
                                    <c:if test="${loginEmp.empid==schedule.empid}">
                                    <button type="submit" class="btn btn-success">保存</button>
                                    <button type="reset" class="btn btn-primary">重置</button>
                                        <a href="javascript:;" name=deleteRow delete_url="${pageContext.request.contextPath}/schedule/removebyid?scheduleId="  key="${schedule.scheduleid}" class="btn btn-info">删除</a>
...
<script>
    ...
    if ('${schedule.ifprivate}'==1)
        $("#ifprivate1").prop("checked",true)
    else
        $("#ifprivate2").prop("checked",true)
    //状态的默认选中
