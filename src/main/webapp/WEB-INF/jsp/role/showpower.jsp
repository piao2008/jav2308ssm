...
<script>
  ...
  //要分配权限角色对应权限默认选中
  let url='${pageContext.request.contextPath}/role/getbyroleid?roleId='+$("#roleid").val()
  ...
  $("#saveMenu").click(function (){
    ...
    //
    location.href='${pageContext.request.contextPath}/role/modifybyroleid?menuids='+menuids+"&roleId="+$("#roleid").val()
  })
</script>
</body>
</html>
